    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="text-center bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <button className="inline-flex items-center justify-center px-6 py-3 bg-white text-blue-600 font-medium rounded-xl hover:bg-neutral-50 border border-blue-200 transition-colors">
