// ===================================
// TODO CLEAN - DEEP CLEAN PROMO
// Promotional banner for deep cleaning services
// ===================================
...
const DeepCleanPromo: React.FC = () => {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent(
      '¡Hola! Me interesa el servicio de limpieza profunda. ¿Podrían darme más información?'
    );
    window.open(
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-indigo-500 via-blue-600 to-cyan-600 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all">
      {/* Logo */}
      ...
      <div className="relative z-10 flex items-start gap-4">
        ...
        <div className="flex-1">
          <h3 className="text-xl font-bold text-white mb-2 drop-shadow-md">
            ¿Hace tiempo que no haces limpieza profunda?
          </h3>
          <p className="text-blue-50 mb-4">
            Incluye <span className="font-bold text-white">ventanas, electrodomésticos por dentro, zócalos</span> y más. Tu hogar como nuevo.
            <span className="block text-sm mt-1">Garantía de satisfacción 100%</span>
          </p>
          <button
            onClick={handleWhatsAppClick}
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-blue-600 font-bold rounded-lg hover:bg-blue-50 transition-all transform hover:scale-105 shadow-md"
          >
