...
const ResidentialServices: React.FC = () => {
  return (
    <div className="space-y-16">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50">
        <div className="grid md:grid-cols-5 gap-0 items-stretch min-h-[450px]">
          ...
          <div className="md:col-span-2 relative overflow-hidden">
            <img
              ...
              alt="Limpieza residencial profesional"
              className="absolute inset-0 w-full h-full object-cover"
            />
            {/* Subtle overlay */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent to-teal-50/30"></div>
          </div>

          {/* Right: Content - 3 columns */}
          <div className="md:col-span-3 p-8 md:p-12 flex flex-col justify-center">
            {/* Icon */}
            <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-2xl mb-6 shadow-lg">
            ...
            <div className="grid grid-cols-3 gap-4 max-w-lg">
              <div className="text-center p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-teal-100 shadow-sm">
                <div className="text-2xl font-bold text-teal-600">350+</div>
                <div className="text-xs text-neutral-600">Clientes</div>
              </div>
              <div className="text-center p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-cyan-100 shadow-sm">
                ...
                <button
                  onClick={() => {
                    const message = encodeURIComponent(
                      `¡Hola! Me interesa cotizar el servicio de ${service.name}.`
                    );
