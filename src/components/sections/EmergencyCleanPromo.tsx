// ===================================
// TODO CLEAN - EMERGENCY CLEAN PROMO
// Promotional banner for emergency/urgent cleaning services
// ===================================
...
const EmergencyCleanPromo: React.FC = () => {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent(
      '¡Hola! Necesito un servicio de limpieza urgente. ¿Tienen disponibilidad hoy?'
    );
    window.open(
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-red-500 via-rose-600 to-pink-600 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all">
      {/* Logo */}
      ...
      <div className="relative z-10 flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-red-50 mb-4">
            Servicio express el mismo día. Atendemos emergencias con tan solo <span className="font-bold text-white">3 horas de anticipación</span>.
            <span className="block text-sm mt-1">Disponibilidad 24/7 para cuando más lo necesites</span>
          </p>
          <button
            onClick={handleWhatsAppClick}
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-red-600 font-bold rounded-lg hover:bg-red-50 transition-all transform hover:scale-105 shadow-md"
          >
...
export default EmergencyCleanPromo;
